@echo off
REM task22: 128 b = m2b4 WKV (64 b) + m4b6 LEARNABLE-cb PQ shifts (2x(24 idx + 8 norm) = 64 b), 2.0 ep.
REM GPU free at launch (serial queue). OMP 4 + fetch 4.
cd /d C:\Users\Andrew\rwkv-state-quant\gpu_train
set CFG=qat_pq_q128L
...
echo ===== task22 128-b QAT (m2b4 + m4b6 learnable shift cb) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
