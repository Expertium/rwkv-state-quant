@echo off
REM task22: 72 b = JOINT m1b4 WKV cb (16 b, learnable) + m4b6 learnable shifts (48) + 1-bit norms (4).
...
echo ===== task22 68-b QAT (JOINT m1b4 learnable + m4b6 learnable + 1-bit norms) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
