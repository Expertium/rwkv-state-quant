@echo off
REM task22: 88 b = m2b3 WKV (24 b idx) + m4b6 LEARNABLE-cb PQ shifts (48 b idx) + int4 norms (16 b, PTQ), 2.0 ep.
...
echo ===== task22 88-b QAT (m2b3 + m4b6 learnable shift cb) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
