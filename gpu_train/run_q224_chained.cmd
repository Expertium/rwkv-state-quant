@echo off
REM task22 ladder rung 3 (224 b): m2b8 PQ + INT2 shifts, 1.5 ep. WAITS for the q272 training to free
...
for /L %%i in (1,1,960) do (
  findstr /C:"DONE_EXIT" "C:\Users\Andrew\rwkv-state-quant\scratchpad\qat_qat_pq_q272.log" >nul 2>&1 && goto :run
...
echo ===== task22 224-b QAT (m2b8 + shift-int2) 1.5ep START %DATE% %TIME% ===== > "%LOG%"
