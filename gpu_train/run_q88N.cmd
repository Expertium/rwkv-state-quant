@echo off
REM task22: 88-b RETRY with QAT-modeled norm quant (RWKV_QAT_NORM_BITS=4). Otherwise = run_q88L.cmd.
...
echo ===== task22 88-b QAT RETRY (m2b3 + m4b6 learnable cb + MODELED int4 norms) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
