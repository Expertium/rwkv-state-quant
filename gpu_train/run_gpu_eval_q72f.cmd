...
set RWKV_QAT_PQ=C:\Users\Andrew\rwkv-state-quant\gpu_train\reference\qat_pq_q72f_wkvcb_6702.txt
...
"%PY%" -u -m rwkv.get_result --config configs/gpu_eval_q72f.toml >> "%LOG%" 2>&1
