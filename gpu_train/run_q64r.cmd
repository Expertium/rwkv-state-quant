@echo off
REM task22: 64 b = m1b5 joint WKV (20, learnable) + m4b5 shifts (40, learnable) + LEARNED ROTATION + 1-bit norms (4).
...
echo ===== task22 64-b QAT (m1b5L + m4b5L + LEARNED ROTATION + 1-bit norms) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
