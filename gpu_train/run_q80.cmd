@echo off
REM task22: 80 b = m2b3 WKV (24) + m4b5 learnable shift cb (40) + modeled int4 norms (16). 2.0 ep.
...
echo ===== task22 80-b QAT (m2b3 + m4b5 learnable cb + modeled int4 norms) 2.0ep START %DATE% %TIME% ===== > "%LOG%"
