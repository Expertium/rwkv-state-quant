...
| **★★★★★ 64 b via LEARNED ROTATION + m4b5 shifts — WIN at the boundary (18:13). THE 8-BYTE CARD: one machine word** | **`q64rv`** | 22 | **64** | 192 | **+0.002492/+0.0012 — imm passes by 0.000008 (RAZOR-thin)** | (2.0-ep QAT: m1b5L WKV + m4b5L shifts + LEARNED Cayley pre-rotation + 1-bit norms) | the rotation recovered ~+0.0002 imm — exactly the m4b5 wall's deficit (+0.0027 → +0.00249) | **✓ SpinQuant→PQ works: cross-chunk correlation moved across the chunk boundary cracks the 32-entry shift wall that failed twice without it. 288×, note = 24 B. ⚠ WEAKEST robustness of the ladder: nbad 173/400, Q3/Q4 quartile means +0.0027/+0.0031 (power users pay); no individual blow-up. VERDICT: boundary win — 72 b stays the COMFORTABLE champion, 64 b is the at-the-gate extreme** |
